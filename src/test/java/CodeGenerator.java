...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://mysql.s.zingson.com:3306/test";
    private static final String JDBC_USERNAME = "appadmin";
    private static final String JDBC_PASSWORD = "appadmin.server";
